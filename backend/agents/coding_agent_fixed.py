...
@media (max-width: 768px) {
    ...
    h2 {
        ...
        # Generate JavaScript functionality (simplified to avoid f-string issues)
...
if __name__ == "__main__":
    uvicorn.run(app, host="0.0.0.0", port=8000)'''
        ...
        return {
            ...
            "dependencies": ["fastapi", "uvicorn", "pydantic", "email-validator"],
            "setup_instructions": "Install dependencies with: pip install fastapi uvicorn pydantic email-validator\n\nRun with: python main.py"
        }
...
export default App;'''
        ...
        return {
            ...
            "features": ["Task management", "State management", "Beautiful UI", "Cross-platform"],
            "dependencies": ["react", "react-native"],
            "setup_instructions": "Install dependencies with: npm install react react-native\n\nRun with: npx react-native run-android or npx react-native run-ios"
        }
    ...
    def _generate_usage_examples(self, code_result: Dict[str, Any]) -> List[str]:
        ...
        examples = {
            ...
            "javascript": [
                ...
                "",
                "// Add a new task",
                "app.addTask('Complete project', 'Finish all remaining tasks');",
                "",
                "// List all tasks",
